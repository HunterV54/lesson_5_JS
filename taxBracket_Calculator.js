        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
               ...
               if (income <= 19050){
                 ...
                 tax = 19050 * 0.10 + (77,400 - 19050) * 0.12 + (income - 77,400) * 0.22;
                 taxRate = 22;
               } //end of else if
               else if (income <= 315000) {
                 tax = 19050 * 0.10 + (77,400 - 19050) * 0.12 +
                       (165,000 - 77,400) * 0.22 + (income - 165,000) * 0.24;
                 taxRate = 24;
               }//end of else if
               else if (income <= 400000) {
                 tax = 19050 * 0.10 + (77,400 - 19050) * 0.12 +
                       (165,000 - 77,400) * 0.22 + (315,000 - 165,000) * 0.24 +
                       (income - 315,000) * 0.32;
                 taxRate = 32;
               }//end of else if
                  ...
                  tax = 19050 * 0.10 + (77,400 - 19050) * 0.12 +
                        (165,000 - 77,400) * 0.22 + (315,000 - 165,000) * 0.24 +
                        (400,000 - 315,000) * 0.32 + (income - 400,000) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 19050 * 0.10 + (77,400 - 19050) * 0.12 +
                        (165,000 - 77,400) * 0.22 + (315,000 - 165,000) * 0.24 +
                        (400,000 - 315,000) * 0.32 + (600,000 - 400,000 ) * 0.35 + (income - 600000) * .37;
                  taxRate = 37;
               }
          ...
          *******************************************************************************/
               ...
               if (income <= 9,525){
               ...
               else if (income <= 82,500) {
                 tax = 9525 * 0.10 + (38700 - 9525) * 0.12 + (income - 38700) * 0.22;
                 taxRate = 22;
               } //end of else if
               else if (income <= 157,500) {
                 tax = 9525 * 0.10 + (38700 - 9525) * 0.12 +
                       (82500 - 38700) * 0.22 + (income - 82500) * 0.24;
                 taxRate = 24;
               }//end of else if
                 ...
                 tax = 9525 * 0.10 + (38700 - 9525) * 0.12 +
                       (82500 - 38,700) * 0.22 + (157500 - 82500) * 0.24 +
                       (income - 157500) * 0.32;
                 taxRate = 32;
               }//end of else if
               else if (income <= 300000) {
                  tax = 9,525 * 0.10 + (38700 - 9,525) * 0.12 +
                        (82500 - 38700) * 0.22 + (157500 - 82500) * 0.24 +
                        (200000- 157500) * 0.32 + (income - 200000) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 9,525 * 0.10 + (38,700 - 9,525) * 0.12 +
                        (82500 - 38700) * 0.22 + (157500 - 82500) * 0.24 +
          ...
          *******************************************************************************/
               ...
               if (income <= 13600){
                 ...
                 tax = 9525 * 0.10 + (51800 - 9525) * 0.12 + (income - 51800) * 0.22;
                 taxRate = 22;
               } //end of else if
               else if (income <= 157,500) {
                 tax = 9525 * 0.10 + (51800 - 9525) * 0.12 +
                 ...
                 taxRate = 32;
                  ...
                  tax = 9,525 * 0.10 + (51800 - 9,525) * 0.12 +
